...
import org.example.repository.acaocorretiva.AcaoCorretiv;
...
public class AcaoCorretivaServiceImpl implements AcaoCorretivaService{
    ...
    private AcaoCorretiv repository;
    private EquipamentoService equipamentoService;
    private FalhaService falhaService;

    public AcaoCorretivaServiceImpl(AcaoCorretiv repository, EquipamentoService equipamentoService, FalhaService falhaService) {
